...
export default function InfoBox({info}) {
    ...
    const INIT_URL = "https://images.unsplash.com/photo-1623846736569-1d90cba76d65?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    ...
    return (
        <div className="InfoBox">
            ...
            <Card sx={{ maxWidth: 345 }} style={{boxShadow: "0 0 10px black"}}>
                <CardMedia
                    sx={{ height: 140 }}
                ...
                <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" component={"span"}>
                        <p>Tempurature = {info.temp}&deg;C</p>
                        <p>Humidity = {info.humidity}</p>
                        <p>Min Temp = {info.tempMin}&deg;C</p>
                        <p>Max Temp = {info.tempMax}&deg;C</p>
                        <p>The Wathers can described as <b>"{info.weather}"</b> and Feels Like = {info.feelsLike}&deg;C</p>
                    </Typography>
                </CardContent>
            </Card>
            </div>
